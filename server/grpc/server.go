...
import (
	...
	logger "github.com/jrobison153/raft/journal"
...
func New() *RaftServer {
	...
	logger := logger.NewArrayJournal()

	return &RaftServer{
		policyClient: client.New(logger),
	}
}
...
func (clientApi *RaftServer) SetClientPolicy(clientPolicy client.Persister) {

	clientApi.policyClient = clientPolicy
}
